...
import 'package:lucky_committee/app/Views/Authentication/signup%20-%20old/enterState.dart';
import 'package:lucky_committee/app/Widgets/authTextField.dart';

class EnterNameView extends StatelessWidget {
  EnterNameView({Key? key}) : super(key: key);
      ...
      body: Column(
        ...
        children: [
          ...
          const AuthTextfield(
            ...
            titlename: "Enter your Full Name",
          ),
          const SizedBox(
            height: 40,
          ),
